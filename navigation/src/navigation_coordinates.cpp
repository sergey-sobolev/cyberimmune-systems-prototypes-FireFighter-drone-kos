...
{
  NavigationCoordinatesHandlerImpl* impl = (NavigationCoordinatesHandlerImpl*)self;
  res->coordinates = impl->handler->Coordinates();
  return NK_EOK;
}

ffd_NavigationCoordinates *NavigationCoordinatesHandler::CreateImpl(rtl_uint32_t coordinates)
{
...
NavigationCoordinatesHandler::NavigationCoordinatesHandler(rtl_uint32_t coordinates)
{}

rtl_uint32_t NavigationCoordinatesHandler::Coordinates()
{
    return 123;
}
