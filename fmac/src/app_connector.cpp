...
AppConnector::ConnectToEAIC()
{
...

  {
    ...
    ffd_EAICActions_proxy_init(
      &m_eaicActionsProxy, &m_eaicTransport.base, riid);
  }
...
bool
AppConnector::StartActionAtEAIC(rtl_uint32_t _task)
{
...
bool
AppConnector::StartActionAtCCU(rtl_uint32_t _task)
{
