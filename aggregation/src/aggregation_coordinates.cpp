...
{
  AggregationCoordinatesHandlerImpl* impl = (AggregationCoordinatesHandlerImpl*)self;
  res->coordinates = impl->handler->Coordinates();
  return NK_EOK;
}

ffd_AggregationCoordinates *AggregationCoordinatesHandler::CreateImpl(rtl_uint32_t coordinates)
{
...
AggregationCoordinatesHandler::AggregationCoordinatesHandler(rtl_uint32_t coordinates)
{}

rtl_uint32_t AggregationCoordinatesHandler::Coordinates()
{
    return 123;
}
